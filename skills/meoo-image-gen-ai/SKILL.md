...
| 场景 | 模型 | 关键参数 | 是否需要图片输入 |
|------|------|---------|:---:|
| 文生图（快速） | `qwen-image-2.0` | `size: "1024*1536"` | 否 |
| 文生图（高质量） | `wan2.7-image` | `size: "2K"`, `thinking_mode: true` | 否 |
| 图像编辑 | `wan2.7-image` | `size: "2K"` | 是（0-9张） |
| 交互式编辑 | `wan2.7-image` | `size: "2K"`, `bbox_list` | 是 |
